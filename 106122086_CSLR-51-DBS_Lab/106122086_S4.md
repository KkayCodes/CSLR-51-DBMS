...
Certainly! I've organized the SQL queries into separate code blocks with paragraph breaks for clarity. You can copy this Markdown text into a `.md` file for GitHub:
